...
const _users = [...Array(24)].map((_, index) => ({
  ...
  role: index === 0 ? "SuperAdmin" : index % 2 ? "Agency" : "User"
}));
...
const _products = [...Array(24)].map((_, index) => {
  ...
  return {
    ...
    colors: setIndex === 1 && COLORS.slice(0, 2) || setIndex === 2 && COLORS.slice(1, 3) || setIndex === 3 && COLORS.slice(2, 4) || setIndex === 4 && COLORS.slice(3, 6) || setIndex === 23 && COLORS.slice(4, 6) || setIndex === 24 && COLORS.slice(5, 6) || COLORS,
